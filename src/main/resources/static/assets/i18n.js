(function () {
  ...
  const dictionaries = {
    ko: {
      ...
      "balance.eyebrow": "Ledger balance",
      "balance.title": "source별 debit / credit",
      ...
      "ledger.debitShort": "차변",
      "ledger.creditShort": "대변",
      "ledger.entries": "건",
    ...
    en: {
      ...
      "balance.eyebrow": "Ledger balance",
      "balance.title": "Debit / credit by source",
      "transactions.eyebrow": "Recent transactions",
      ...
      "ledger.debitShort": "Debit",
      "ledger.creditShort": "Credit",
    ...
    ja: {
      ...
      "balance.eyebrow": "Ledger balance",
      "balance.title": "source 別 debit / credit",
      "transactions.eyebrow": "Recent transactions",
      ...
      "ledger.debitShort": "借方",
      "ledger.creditShort": "貸方",
      "ledger.entries": "件",
    ...
    "zh-CN": {
      ...
      "balance.eyebrow": "Ledger balance",
      "balance.title": "按 source 的 debit / credit",
      "transactions.eyebrow": "Recent transactions",
