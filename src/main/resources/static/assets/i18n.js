(function () {
  ...
  const dictionaries = {
    ko: {
      ...
      "runtime.aria": "정산 런타임 운영 요약",
      "runtime.eyebrow": "Continuous settlement runtime",
      "runtime.title": "런타임·손익·capacity·backlog 한눈에 보기",
      "runtime.pipeline": "파이프라인",
      "runtime.calculationScope": "계산 범위",
      "runtime.operatingProfit": "영업이익",
      "runtime.operatingProfitHelp": "수익에서 운영 비용을 차감한 값",
      "runtime.cashBalance": "Synthetic 현금 잔고",
      "runtime.margin": "영업이익률",
      "runtime.capacity": "capacity 활용률",
      "runtime.delayRate": "정산 지연율",
      "runtime.backlog": "운영 backlog",
      "runtime.backlogHelp": "승인 / 정산 / 대사 / callback",
      "runtime.backlogDetail": "승인 {approval} / 정산 {settlement} / 대사 {reconciliation} / callback {callback}",
      "runtime.available": "데이터 사용 가능",
      "runtime.noData": "데이터 없음",
      "metrics.service": "서비스",
      ...
      "transactions.table.processedAt": "처리 시각",
    ...
    en: {
      ...
      "runtime.aria": "Settlement runtime overview",
      "runtime.eyebrow": "Continuous settlement runtime",
      "runtime.title": "Runtime, balance, capacity, and backlog at a glance",
      "runtime.pipeline": "Pipeline",
      "runtime.calculationScope": "Calculation scope",
      "runtime.operatingProfit": "Operating profit",
      "runtime.operatingProfitHelp": "Revenue less operating cost",
      "runtime.cashBalance": "Synthetic cash balance",
      "runtime.margin": "Operating margin",
      "runtime.capacity": "Capacity utilization",
      "runtime.delayRate": "Settlement delay rate",
      "runtime.backlog": "Operational backlog",
      "runtime.backlogHelp": "Approval / settlement / reconciliation / callback",
      "runtime.backlogDetail": "Approval {approval} / Settlement {settlement} / Reconciliation {reconciliation} / Callback {callback}",
      "runtime.available": "Data available",
      ...
      "transactions.table.processedAt": "Processed at",
    ...
    ja: {
      ...
      "runtime.aria": "精算ランタイム運用サマリー",
      "runtime.eyebrow": "Continuous settlement runtime",
      "runtime.title": "ランタイム・収益・capacity・backlog の概要",
      "runtime.pipeline": "パイプライン",
      "runtime.calculationScope": "計算範囲",
      "runtime.operatingProfit": "営業利益",
      "runtime.operatingProfitHelp": "収益から運用コストを差し引いた値",
      "runtime.cashBalance": "Synthetic 現金残高",
      "runtime.margin": "営業利益率",
      "runtime.capacity": "capacity 稼働率",
      "runtime.delayRate": "精算遅延率",
      "runtime.backlog": "運用 backlog",
      "runtime.backlogHelp": "承認 / 精算 / 照合 / callback",
      "runtime.backlogDetail": "承認 {approval} / 精算 {settlement} / 照合 {reconciliation} / callback {callback}",
      "runtime.available": "データあり",
      "runtime.noData": "データなし",
      ...
      "transactions.table.processedAt": "処理時刻",
      "runbook.aria": "運用確認手順",
      "runbook.eyebrow": "Runbook",
    ...
    "zh-CN": {
      ...
      "summary.aria": "运维摘要指标",
      "runtime.aria": "结算运行时运维摘要",
      "runtime.eyebrow": "Continuous settlement runtime",
      "runtime.title": "运行时、损益、capacity 与 backlog 概览",
      "runtime.pipeline": "管道",
      "runtime.calculationScope": "计算范围",
      "runtime.operatingProfit": "营业利润",
      "runtime.operatingProfitHelp": "收入减去运营成本",
      "runtime.cashBalance": "Synthetic 现金余额",
      "runtime.margin": "营业利润率",
      "runtime.capacity": "capacity 利用率",
      "runtime.delayRate": "结算延迟率",
      "runtime.backlog": "运营 backlog",
      "runtime.backlogHelp": "审批 / 结算 / 对账 / callback",
      "runtime.backlogDetail": "审批 {approval} / 结算 {settlement} / 对账 {reconciliation} / callback {callback}",
      "runtime.available": "数据可用",
      "runtime.noData": "暂无数据",
      "metrics.service": "服务",
      ...
      "transactions.table.processedAt": "处理时间",
      "runbook.aria": "运维检查顺序",
      "runbook.eyebrow": "Runbook",
